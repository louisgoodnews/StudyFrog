...
__all__: Final[List[str]] = ["FlashcardsViewUI"]


class FlashcardsViewUI(BaseUI):
    """
    A class representing the flashcards view user interface (UI) of the application.

    This class is responsible for initializing and configuring the layout of the
    flashcards view UI, including setting up the main frames and populating them with
    ...
    def __init__(
        ...
        """
        Initializes a new instance of the FlashcardsViewUI class.
    ...
    def configure_grid(self) -> None:
        """
        Configures the grid of the flashcards view widget.

        This method configures the grid of the flashcards view widget by setting the
        ...
        # Configure the flashcards view widget's 1st column to weight 1.
        ...
        # Configure the flashcards view widget's 1st and 3rd row to weight 0.
        ...
        # Configure the flashcards view widget's 2nd row to weight 1.
    ...
    def create_widgets(self) -> None:
        """
        Creates and configures the main frames of the flashcards view UI.

        This method initializes the top, center, and bottom frames within the
        flashcards view UI, setting their layout configuration and invoking methods
