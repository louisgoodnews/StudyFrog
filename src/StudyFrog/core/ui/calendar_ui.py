...
class CalendarUI(BaseUI):
    ...
    calendar menu UI, including setting up the main frames and populating them with
    ...
    def __init__(
        ...
        """
        Initializes a new instance of the CalendarUI class.
    ...
    def configure_grid(self) -> None:
        ...
        This method configures the grid of the calendar menu widget by setting the
        ...
        # Configure the calendar menu widget's 1st column to weight 1.
        ...
        # Configure the calendar menu widget's 1st and 3rd row to weight 0.
        ...
        # Configure the calendar menu widget's 2nd row to weight 1.
