...
class HelpUI(tkinter.Frame):
    ...
    def __init__(
        ...
        # Grid the help menu widget in its master
        self.grid(
            column=0,
            row=0,
            sticky=NSEW,
    ...
    def user_widgets(self) -> None:
        ...
        # Help the "Top Frame" frame widget
        ...
        # Help the "Center Frame" frame widget
        ...
        # Help the "Bottom Frame" frame widget
        ...
        # Help the "Bottom Frame" frame widgets
        self.user_bottom_frame_widgets(master=bottom_frame)

        # Help the "Center Frame" frame widgets
        self.user_center_frame_widgets(master=center_frame)

        # Help the "Top Frame" frame widgets
