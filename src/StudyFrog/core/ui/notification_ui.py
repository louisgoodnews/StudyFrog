...
class NotificationUI(tkinter.Frame):
    """
    ...
    def __init__(
        ...
        # Notification the widgets
        self.user_widgets()

        # Grid the notification menu widget in its master
        self.grid(
            column=0,
            row=0,
            sticky=NSEW,
    ...
    def user_widgets(self) -> None:
        """
        Notifications and configures the main frames of the notification menu UI.
        ...
        # Notification the "Top Frame" frame widget
        ...
        # Notification the "Center Frame" frame widget
        ...
        # Notification the "Bottom Frame" frame widget
        ...
        # Notification the "Bottom Frame" frame widgets
        self.user_bottom_frame_widgets(master=bottom_frame)

        # Notification the "Center Frame" frame widgets
        self.user_center_frame_widgets(master=center_frame)

        # Notification the "Top Frame" frame widgets
    ...
    def user_bottom_frame_widgets(
        ...
        """
        Notifications and configures the main widgets of the bottom frame.
    ...
    def user_center_frame_widgets(
        ...
        """
        Notifications and configures the main widgets of the center frame.
    ...
    def user_top_frame_widgets(
        ...
        """
        Notifications and configures the main widgets of the top frame.
