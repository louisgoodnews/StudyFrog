...
NAME: Final[Literal["gui.views.forms.subject_create_form"]] = "gui.views.forms.subject_create_form"
...
def get_subject_create_form(master: tkinter.Frame) -> None:
    """
    Get the subject create form.
    ...
    try:
        log_info(
            message="Getting subject create form",
            name=NAME,
        )
        ...
        log_info(
            message="Got subject create form successfully",
            name=NAME,
        )
    except Exception as e:
        log_exception(
            exception=e,
            message="Failed to get subject create form",
            name=NAME,
        )
        raise Exception(f"Failed to get subject create form: {e}") from e
