...
NAME: Final[Literal["gui.views.forms.teacher_create_form"]] = "gui.views.forms.teacher_create_form"
...
def get_teacher_create_form(master: tkinter.Frame) -> None:
    """
    Get the teacher create form.
    ...
    try:
        log_info(
            message="Getting teacher create form",
            name=NAME,
        )
        ...
        log_info(
            message="Got teacher create form successfully",
            name=NAME,
        )
    except Exception as e:
        log_exception(
            exception=e,
            message="Failed to get teacher create form",
            name=NAME,
        )
        raise Exception(f"Failed to get teacher create form: {e}") from e
