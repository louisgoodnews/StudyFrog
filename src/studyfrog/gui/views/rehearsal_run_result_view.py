...
NAME: Final[Literal["gui.views.views.rehearsal_run_result_view"]] = (
    "gui.views.views.rehearsal_run_result_view"
)
...
def get_rehearsal_run_result_view() -> None:
    """
    Returns the rehearsal run result view.
