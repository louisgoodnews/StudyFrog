...
NAME: Final[Literal["gui.views.views.rehearsal_run_setup_view"]] = (
    "gui.views.views.rehearsal_run_setup_view"
)
...
def get_rehearsal_run_setup_view() -> None:
    """
    Returns the rehearsal run setup view.
