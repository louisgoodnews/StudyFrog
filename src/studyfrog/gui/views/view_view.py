...
NAME: Final[Literal["gui.views.views.view_view"]] = "gui.views.views.view_view"
...
def get_view_view(master: tkinter.Toplevel) -> None:
    """
...
def get_master() -> tkinter.Toplevel:
    """
    Returns the master of the view view.
...
def set_master(master: tkinter.Toplevel) -> None:
    """
    Sets the master of the view view.
